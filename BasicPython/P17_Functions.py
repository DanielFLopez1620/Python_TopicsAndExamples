print("""*ABSTRACTION: You do not need to know all about something to use it, for example, a car or a calculator
Remember, it is important to understand how to use a program, library, command...
...
def yourName(first,last,order = False): #Function with three params, one is a default param
    if not order:
        return last + " " + first
    else:
        return first + " " + last
