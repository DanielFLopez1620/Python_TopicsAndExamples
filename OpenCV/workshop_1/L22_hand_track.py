    ...
    while True:
        ...
        * type: Indicates whether the hand is right or left
        ...
        if hands:
            ...
            length, info, fotogram = handDetector.findDistance(
                firstLmList[8][0:2], firstLmList[12][0:2], fotogram
            )
        ...
        if len(hands) == 2:
            ...
            length, info, fotogram = handDetector.findDistance(
                firstCenter, secondCenter, fotogram
            )
            print(f"Distance between hands: {length}")
